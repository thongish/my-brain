...
What is the symbol that represents the **population mean**?::<font size=6>μ</font>

What is the symbol that represents **sample standard deviation**?::<font size=6>s</font>

What is the symbol that represents **population standard deviation**?::<font size=6>σ</font>

What is the symbol that represents **median**?::<font size=6>x̃</font>

What is the symbol that represents **skewness**?::<font size=6>Sk</font>
...
What is a **mean**?::The average of a data set 
...
- if there are two values that occur with the same frequency, that data set is **bimodal**
- if there are more than two values, the data set is **multi-modal**
- if no value is repeated, there is no mode

For an odd number of data values in a set, the median is...::The exact middle value in the set

For an even number of data values in a set, the median is...::The mean of the two middle numbers

What is **range**?::The difference between the maximum and minimum value of a data set
...
?
- if Sk < -1.0, the data is skewed left
- if Sk > 1.0, the data is skewed right
- if -1.0 < Sk < 1.0, the data is not significantly skewed

What is the **proportion formula**?
?
![[Pasted image 20240924235236.png]]

Look at this example of a **two-way table**
?
![[Pasted image 20240924235324.png]]

What is **variance**?::The square of deviation